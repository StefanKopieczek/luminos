...
_start:
    ...
    control of the CPU. The kernel can only make use of hardware
    features and any code it provides as part of itself. There's no printf
    function, unless the kernel provides its own <stdio.h> header and a
    printf implementation. There are no security restrictions, no safeguards,
    no debugging mechanisms - only what the kernel provides itself.
    ...
    */
    ...
    instructions and instruction set extensions are not initialized yet.
    ...
    */
    ...
    stack (i.e. zero bytes), and the alignment is thus preserved and the call
    is well defined.
    */
    call kernel_main
